define(['managerAPI',
    'https://cdn.jsdelivr.net/gh/minnojs/minno-datapipe@1.*/datapipe.min.js'], function (Manager) {
        ...
        init_data_pipe(API, 'rWSniYN9MdAv', { file_type: 'csv' });
        ...
        API.addTasksSet({
            ...
            // Second intro (for second round)
            intro_2: [{
                inherit: 'instructions',
                name: 'intro_2',
                templateUrl: 'intro_2.jst',  // Use a different .jst if needed
                title: 'Intro - Round 2',
                header: 'Second Round'
            }],
            ...
            raceiat_instructions_validating: [{
                inherit: 'instructions',
                name: 'raceiat_instructions_validating',
                templateUrl: 'raceiat_instructions_validating.jst', // Separate file or reused
                title: 'IAT Instructions (validating)',
                header: 'Second IAT'
            }],
            ...
            lastpage: [{
                ...
                //last:true, 
                header: 'hai completato lo studio'
            }],
            ...
            uploading: uploading_task({ header: 'attendi un momento', body: 'salvataggio dati... ' })
        });
